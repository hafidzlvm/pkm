...
export function AnimatedSocialIcon({ href, icon, label }: AnimatedSocialIconProps) {
  return (
    <motion.a
      href={href}
      target="_blank"
      ...
      whileTap={{ scale: 0.95 }}
      className="w-12 h-12 rounded-full border border-[rgba(212,175,55,0.2)] flex items-center justify-center text-[rgba(229,228,226,0.6)] hover:text-[#D4AF37] hover:border-[#D4AF37] transition-colors duration-300 cursor-pointer"
    >
      {icon}
    </motion.a>
  );
